...
class MainFragment : Fragment() {
    ...
    private fun showSelectedItem(Artist: ArtistModel){
       ArtistViewModel.setSelectedEmployee(employee)
        findNavController().navigate(R.id.action_mainFragment3_to_viewEmployeeFragment)
    }

    private fun displayEmployees(){
        adapter.setData(employeeList = ArtistViewModel.getArtist())
    ...
    private fun recyclerView(view: View){
        ...
        adapter = ArtistRecyclerViewAdapter { selectedEmployee ->
